...
<html>
<head>
	<title>PortFolio: Edit Item</title>
</head>
<body>
		...
		<div class="itemContainer widthAuto">
			<form id="addItemForm" enctype="multipart/form-data">
				...
				<div id="textAreas" class="left">
					...
					<textarea name="description" rows="6"  maxlength="255" required></textarea><br>
				...
				<div id="imagesInput">
					...
					<p id="currentlyUploadedImages"></p>
					<label>Upload extra images:</label><br>
	...
	<script type="text/javascript" src="../js/editItemLoadData.js"></script>
